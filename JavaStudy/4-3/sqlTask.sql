...
-- [SELECT store_name FROM store_table
    SELECT name AS "店舗名" FROM store_table]
...
-- [SELECT store_name FROM stock_table
    JOIN store_table ON stock_table.store_code = store_table.store_code;
    SELECT goods_name FROM stock_table
